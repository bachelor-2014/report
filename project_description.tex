...
\begin{ganttchart}[vgrid, hgrid]{20}{20}
    ...
    \ganttmilestone{Project in project base}{4} \ganttnewline
    \ganttmilestone{Submit project for approval}{6} \ganttnewline

    \ganttgroup{1. BeagleBoard}{5}{10} \\
    \ganttbar{1.1 OS and OpenCV}{5}{5} \\
    \ganttbar{1.2 Drivers}{6}{8} \\
    \ganttbar{1.3 Hardware interaction}{6}{8} \\
    \ganttbar{1.4 Hardware API}{9}{10} \\

    \ganttgroup{2. Camera}{11}{19} \\
    \ganttbar{2.1 Hardware setup}{11}{13} \\
    \ganttbar{2.2 Image stitching}{14}{17} \\
    \ganttbar{2.3 Camera experiments}{16}{17} \\
    \ganttbar{2.4 Camera API}{18}{19} \\

    \ganttgroup{Finish report}{20}{20} \\

    \ganttmilestone{Handin}{20}
\end{ganttchart}
